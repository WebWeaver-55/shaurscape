    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-background">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl w-full">
        {[
          {
            class: '10',
            description: 'CBSE/ICSE Class 10 Study Materials',
            icon: '📚',
          },
          {
            class: '12',
            description: 'CBSE/ISE Class 12 Study Materials',
            icon: '🎓',
          },
        ].map((item) => (
          <button
            key={item.class}
            onClick={() => onSelectClass(item.class as '10' | '12')}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl font-bold text-foreground mb-3">Class {item.class}</h2>
